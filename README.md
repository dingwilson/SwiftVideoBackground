...
#### Version 3.0.0
- Passing in an array of videos support removed. You should merge videos in advance instead. One way to merge videos is with [FFmpeg](http://wilsonding.com/2018/03/02/concatenate-multimedia-files-with-ffmpeg/).
