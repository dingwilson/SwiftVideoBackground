#
#  Be sure to run `pod spec lint SwiftVideoBackground.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Wilson Ding"
  # s.authors            = { "Wilson Ding" => "shodai100@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Wilson Ding"
  ...
  s.source       = { :git => "https://github.com/dingwilson/SwiftVideoBackground.git", :tag => "0.01" }
